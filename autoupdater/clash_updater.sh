...
cp autoupdater/*.* ${UPDATER_VOLUME}/

# TODO: update config to match your provider's clash download link
# the links should keep secret and DO NOT upload to git repo
# cp autoupdater/conf/*.* ${UPDATER_VOLUME}/
...
echo "==================================" >> ${UPDATER_VOLUME}/data/updater_all.log

if grep -Fq "FAIL::" ${UPDATER_VOLUME}/data/updater.log; then
